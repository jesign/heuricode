...
class FeedbackTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('feedbacks')->insert(array(
	    	...
	    	array('id' => 4,
	    			    	'description' => 'The Logical operators AND(&&), OR(||) and NOT(!) will be very helpful in setting the conditions.'),
	    	array('id' => 5,
	    			    	'description' => 'The Logical operators AND(&&), OR(||) and NOT(!) will be very helpful in setting the conditions.'),
	    	array('id' => 6,
	    	...
	    	array('id' => 8,
	    			    	'description' => 'You can create multiple if else statements in the format: if(condition1){ \n//do condition 1\n}else if(condition2){\n//do condition 2
	    										\n}else if(condition3){\n//do condition 3\n}'),
	    	array('id' => 9,
	    			    	'description' => "You can create a switch case statement using the following format:\n\n
	    			    	switch(test){\n\t
	    			    	case 1:	\n\t\t
	    			    	// Process for test = 1\n\t\t
	    			    	...\n\t
	    	...
	    	array('id' => 10,
	    			    	'description' => 'Remember to use the if else statement the next time you attempt to solve this problem.'),
	    	array('id' => 11,
	    	...
	    	array('id' => 21,
	    			    	'description' => 'or loop is created in the format:\nfor(int num=0;num<how many times you want to loop;num++ ){\n\t
	    			    	//code that will be run depending on the loop\n}'),
	    	array('id' => 22,
